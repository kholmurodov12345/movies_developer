...
averageRating: 0,
originalTitle: "",
storyline: "A Sci-Fi family revenge drama happening between a scientist, his evil brother and the scientist's son, over a time travel gadget. Written by Naveen Sankaran",
actors: [
"Suriya",
...
averageRating: 0,
originalTitle: "",
storyline: "'Madaari' is the story of a common man who sets out to avenge the death of his son caused by rampant corruption in the government. Losing the only family he had brings him to kidnap the home minister's son and bring those responsible to justice. Written by Keith Francis Bacon",
actors: [
"Irrfan Khan",
"Jimmy Shergill",
"Vishesh Bansal"
...
averageRating: 0,
originalTitle: "",
storyline: "A young man (Raghu) wants revenge from the people who killed his wife and son in a bank robbery.There are two suspects in this case ,one escapes with the money and the other gets caught by the cops and is sentenced 20 years in jail. Fifteen years later he is suffering from cancer and he has only a year to live, so he requests Raghu to forgive his rest of the sentenced and let him get out from the jail. Raghu accepts his apology only on one condition that he names his partner. So after 15 years will Raghu be able to find the other suspect who destroyed his life? Will he punish him and take his 15 years old revenge? Written by Deepika Mallar",
actors: [
"Varun Dhawan",
"Nawazuddin Siddiqui",
"Yami Gautam"
...
averageRating: 0,
originalTitle: "",
storyline: "Jagdish (Vijay), an army captain, is back in Mumbai for a holiday to be with his parents and two sisters. They want him to get married and finds a bride Nisha (Kajal Aggarwal) for him. After the usual bickerings the couple fall in love. Meanwhile Jagadish an intelligence officer in the military, has a mission to crack down on terrorist sleeper cells in Mumbai. How Jagadish moving around as an ordinary person using his brain and brawn in the correct measure, tracks down the terrorist in his own unique way forms the rest of this escapist entertainer. Written by Surya Prakash",
actors: [
"Joseph Vijay",
"Kajal Aggarwal",
"Vidyut Jamwal"
...
averageRating: 0,
originalTitle: "",
storyline: "Ishqiya is a story about love arising in characters, portrayed uniquely according to their own personal traits. The situations in the plot lead the characters to experience the emotion creeping into their lives in the most unexpected manner. Written by Shemaroo Entertainment Pvt Ltd",
actors: [
"Naseeruddin Shah",
"Vidya Balan",
"Arshad Warsi"
...
averageRating: 0,
originalTitle: "",
storyline: "The story revolves around a remote village in Andhra Pradesh plagued by a strange disease killing a lot of people. The soothsayer of the village predicts that God would come to their village for rescue. Meanwhile, Raju (Mahesh Babu) a cab driver in Hyderabad goes to Rajasthan to handover an insurance cheque to a man's family who dies in his car. In a strange situation, Raju meets a man from the village and gets to know about their problem. Soon Raju realizes he is none other than the God-sent, the soothsayer predicted, and the rest of the story is all about how Raju takes up the responsibility to rescue the village from the clutches of evil. Written by Anonymous",
actors: [
"Mahesh Babu",
"Anushka Shetty",
"Prakash Raj"
...
averageRating: 0,
originalTitle: "",
storyline: "'Tere Bin Laden' is a tongue-in-cheek comedy about an ambitious young news reporter from Pakistan who is desperate to migrate to the US in pursuit of the American dream. His repeated attempts to immigrate are shot down as his visa is always rejected. But when things couldn't look worse he comes across an Osama bin Laden look alike. Ali then hatches a scheme to produce a fake Osama video and sell it to news channels as a breakthrough scoop! Unfortunately there are serious ramifications as the White House gets involved and dispatches a overzealous secret agent on Ali's trail. Written by Anonymous",
actors: [
"Ali Zafar",
"Pradhuman Singh",
"Piyush Mishra"
...
averageRating: 0,
originalTitle: "",
storyline: "A psychological thriller which depicts the fact that 'Today is a gift - that's why it's called Present' in an unusual way. It is about a man called Neenu, who lives in the present. The film takes the audience through a journey of his life by detailing why Neenu lives in the present, by exploring his past and his future - both as seen by different people in Neenu's life. The film also highlights that happiness can be attained by means other than wealth. Written by Sooji",
actors: [
"Upendra",
"Kristina Akheeva",
"Parul Yadav"
...
averageRating: 0,
originalTitle: "",
storyline: "Auro (Amitabh Bachchan) is an intelligent and witty 13-year-old boy with an extremely rare genetic defect that causes accelerated aging. He suffers from a progeria-like syndrome. Mentally he is 13, very normal, but physically he looks five times older. In spite of his condition, Auro is a very happy boy. He lives with his mother Vidya (Vidya Balan) who is a gynecologist. Amol Arte (Abhishek Bachchan) is young, progressive and a full-of-ideals politician. He is out to prove to the world that 'politics' is not a bad word. He is a man with a mission. Auro is Amol's son. Written by Big Pictures",
actors: [
"Amitabh Bachchan",
"Abhishek Bachchan",
"Vidya Balan"
...
averageRating: 0,
originalTitle: "",
storyline: "A top shot model Diya (Amy Jackson) falls in love with Mr. Tamil Nadu Lingesan (Vikram), and together they become the most wanted model pair in the country. When Lingesan rejects an advertisement of a wealthy businessman (Ramkumar), who gave him the big break into ad world, he plans revenge against him. Now, he is joined by a greedy model (Upen Patel), lusty doctor (Suresh Gopi) and a trans-gender stylist who are out to cause massive damage to Lingesan's life which is worse than death. The rest of the story is how Lingesan takes revenge against these powerful people in the society. Written by Ravi",
actors: [
"Vikram",
"Amy Jackson",
"Suresh Gopi"
...
averageRating: 0,
originalTitle: "",
storyline: "'Wazir' is a tale of two unlikely friends, a wheelchair-bound chess grandmaster and a brave ATS officer. Brought together by grief and a strange twist of fate, the two men decide to help each other win the biggest games of their lives. But there's a mysterious, dangerous opponent lurking in the shadows, who is all set to checkmate them. Written by Abhijat Joshi",
actors: [
"Amitabh Bachchan",
"Farhan Akhtar",
"Aditi Rao Hydari"
...
averageRating: 0,
originalTitle: "",
storyline: "Gabbar Singh Rajput (Akshay Kumar) creates his own vigilante military network called the Anti-Corruption Force (ACF) that eliminates the most corrupt individuals, from all walks of life, in a systematic manner. As pressure builds on Police and Government to track down the man who masterminds these killings, Balbir Singh (Sonu Sood) is specially summoned to head the task. He is aided by Suryam (Prakash Raj) who, though being just a constable in the mammoth Police force, is compelled by his instincts to see through the underlying design. Written by Anonymous",
actors: [
"Akshay Kumar",
"Shruti Haasan",
"Sunil Grover"
...
averageRating: 0,
originalTitle: "",
storyline: "Tamasha is about the journey of someone who has lost his edge in trying to follow socially acceptable conventions of society. The film is based on the central theme of abrasion and loss of self that happens in an attempt to find oneself. Written by King Motwani",
actors: [
"Deepika Padukone",
"Ranbir Kapoor",
"Piyush Mishra"
...
averageRating: 0,
originalTitle: "",
storyline: "Ram (Shaam) and Lakshman a.k.a Lucky (Allu Arjun) are brothers. Ram is a sincere guy who grows up to become an honest cop. Lucky is a happy-go-lucky guy who enjoys life. Ram and Lucky have a tom and jerry kind of fight going on. Siva Reddy (Ravi Kishan) is a factionist who wants to become a politician. Ram gathers evidence against Siva Reddy and Lucky unintentionally intercepts them. The rest of the story is all about the race between Lucky and Siva Reddy. Written by shashank",
actors: [
"Allu Arjun",
"Shruti Haasan",
"Shaam"
